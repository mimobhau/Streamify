...
const SignUpPage = () => {
  ...
  const {mutate: signupMutation, isPending, error} = useMutation({
    ...
    // after successful signup, invalidate the "authUser" query to refetch user data
    // which navigates the user to the 'home page'
  })

  // 'mutate' is used to trigger the mutation, 'isPending' indicates if the mutation is in progress
  // after submitting the form, the mutation will be triggered
    ...
    <div className="h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
      <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
          ...
          {/* if error is truthy, then render the JSX inside the parentheses. */}
          {error && (
